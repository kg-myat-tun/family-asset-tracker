...
const en: Dictionary = {
  ...
  nav: { overview: "Overview", assets: "Assets", loans: "Loans", members: "Members", profile: "Profile" },
  header: {
...
const my: Dictionary = {
  ...
  dashboard: {
    ...
    trendEmpty:
      "မှတ်တမ်း မလုံလောက်သေးပါ — နေ့စဉ် မှတ်တမ်းတင်သွားမည်ဖြစ်ပြီး လာမည့်ရက်များတွင် ပြည့်စုံလာပါမည်။",
