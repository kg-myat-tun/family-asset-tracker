...
function getAdminApp() {
  ...
  const serviceAccountPath = resolve(process.env.FIREBASE_SERVICE_ACCOUNT_KEY_PATH!);
...
> **Important:** Never commit your service account JSON file. The current
> `.gitignore` already excludes common names like `firebase/serviceAccountKey.json` and
